...
import '@web3inno/appkit-ui/src/composites/wui-compatible-network'
import type { WuiCompatibleNetwork } from '@web3inno/appkit-ui/src/composites/wui-compatible-network'
