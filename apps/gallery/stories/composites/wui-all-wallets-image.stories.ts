...
import '@web3inno/appkit-ui/src/composites/wui-all-wallets-image'
import type { WuiAllWalletsImage } from '@web3inno/appkit-ui/src/composites/wui-all-wallets-image'
