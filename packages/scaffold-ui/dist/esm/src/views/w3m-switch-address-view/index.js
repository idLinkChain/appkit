...
import { AccountController, BlockchainApiController, ChainController, ModalController, OptionsController, StorageUtil } from '@web3inno/appkit-core';
...
let W3mSwitchAddressView = class W3mSwitchAddressView extends LitElement {
    ...
    onSwitchAddress(address) {
        ...
        const caipAddress = `${activeChainNamespace}:${caipNetwork?.chainId}:${address}`;
