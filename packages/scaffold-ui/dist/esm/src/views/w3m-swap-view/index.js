...
import { SwapController, RouterController, CoreHelperUtil, ModalController, EventsController, AccountController, ChainController, NetworkController } from '@web3inno/appkit-core';
...
let W3mSwapView = class W3mSwapView extends LitElement {
    constructor() {
        ...
        this.caipNetworkId = ChainController.state.activeCaipNetwork?.id;
