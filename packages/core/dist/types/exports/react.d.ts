export declare function useAppKitNetwork(): {
    caipNetwork: {
        ...
        readonly chainId: import("@web3inno/appkit-common").ChainId;
        readonly chainNamespace: import("@web3inno/appkit-common").ChainNamespace;
    ...
    chainId: import("@web3inno/appkit-common").ChainId | undefined;
};
